document.addEventListener('DOMContentLoaded', () => {
  ...
  function indicateStylesChange() {
      const stylesSaveSection = downloadStylesBtn.closest('.save-section');
      if(stylesSaveSection) {
        stylesSaveSection.style.borderColor = 'var(--accent-color)';
        stylesSaveSection.style.borderWidth = '2px';
      }
  }
  ...
  function downloadStylesFile() {
      ...
      const stylesSaveSection = downloadStylesBtn.closest('.save-section');
      stylesSaveSection.style.borderColor = '#eee';
      stylesSaveSection.style.borderWidth = '1px';
  }
